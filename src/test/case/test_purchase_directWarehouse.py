...
from src.test.page.purchase.purchaseOrder_add_directWarehouse_page import PurchaseOrderAddPage
    ...
    def test_purchaseOrder(self):
        ...
        for d in datas:
            with self.subTest(data=d):
                ...
                time.sleep(1)
                self.page.purchase_order_new(d['supplier'],d['warehouse'],d['purchasePrice'],d['purchaseAmount'],d['purchaseWeight'],d['InWarehouseAmount'],d['InWarehouseWeight'],d['PingMin'])
                time.sleep(2)
...
if __name__ == '__main__':
    report = REPORT_PATH + '\\test_purchase_directWarehousing.html'
